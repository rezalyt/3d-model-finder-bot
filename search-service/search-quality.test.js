...
test('requested format is enforced', () => {
  const model = { name: 'Birch', source: 'polyhaven', sourceUrl: 'https://example.test/birch', formats: ['blend', 'fbx'], thumbnailUrl: 'x' };
...
test('strict relevance rejects unrelated models and missing previews', () => {
  const models = [
    { name: 'Birch Tree', source: 'polyhaven', sourceUrl: 'https://a.test/birch', formats: ['fbx', 'glb'], tags: ['birch', 'tree', 'landscape'], thumbnailUrl: 'x', license: 'CC0' },
    { name: 'Lot with House', source: 'polyhaven', sourceUrl: 'https://b.test/lot', formats: ['blend'], tags: ['architecture', 'house', 'site'], thumbnailUrl: 'x', license: 'CC0' },
    { name: 'Unknown Asset', source: 'ambientcg', sourceUrl: 'https://c.test/unknown', formats: ['obj'], tags: ['rock'], license: 'CC0' },
    { name: 'Sketchfab Birch', source: 'sketchfab', sourceUrl: 'https://sketchfab.com/x', formats: ['glb'], tags: ['birch'], thumbnailUrl: 'x', license: 'CC0' },
  ];
